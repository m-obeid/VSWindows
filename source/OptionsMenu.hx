...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Misc", [
			...
			//new BotPlay("Showcase your charts and mods with autoplay.") dont cheat xd
		]),
	...
	override function create()
	{
		...
		#if desktop
		if (Sys.args().contains("--allowDevTools"))
		{
			options = [new OptionCategory("Gameplay", [
				new DFJKOption(controls),
				new DownscrollOption("Toggle making the notes scroll down rather than up."),
				new AccuracyDOption("Change how accuracy is calculated. (Accurate = Simple, Complex = Milisecond Based)")
			]),
		...
		if (urlHandler.hostname == "127.0.0.1" || urlHandler.hostname == "localhost")
		{
			options = [new OptionCategory("Gameplay", [
				new DFJKOption(controls),
				new DownscrollOption("Toggle making the notes scroll down rather than up."),
