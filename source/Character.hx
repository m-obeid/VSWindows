...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'windows':
				// Windows lol
				tex = Paths.getSparrowAtlas('System32','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'System32 idle', 24, false);
				animation.addByPrefix('singUP', 'System32 up', 24);
				animation.addByPrefix('singRIGHT', 'System32 right', 24);
				animation.addByPrefix('singDOWN', 'System32 down', 24);
				animation.addByPrefix('singLEFT', 'System32 left', 24);

				animation.addByPrefix('singUPmiss', 'System32 miss up', 1);
				animation.addByPrefix('singRIGHTmiss', 'System32 miss right', 1);
				animation.addByPrefix('singDOWNmiss', 'System32 miss down', 1);
				animation.addByPrefix('singLEFTmiss', 'System32 miss left', 1);
			...
			case 'windowsAngry':
					// Funny windows
					tex = Paths.getSparrowAtlas('WINDOWS ANGRY HAHA','shared',true);
					frames = tex;
					animation.addByPrefix('idle', 'WINDOWS ANGRY HAHA idle', 24);
					animation.addByPrefix('singUP', 'WINDOWS ANGRY HAHA up', 24);
					animation.addByPrefix('singRIGHT', 'WINDOWS ANGRY HAHA right', 24);
					animation.addByPrefix('singDOWN', 'WINDOWS ANGRY HAHA down', 24);
					animation.addByPrefix('singLEFT', 'WINDOWS ANGRY HAHA left', 24);
			...
			case 'vista':
				// Windows vita lol
				tex = Paths.getSparrowAtlas('vita lol', 'shared', true);
				frames = tex;
				animation.addByPrefix('idle', 'vita lol idle', 24);
				animation.addByPrefix('singUP', 'vita lol up', 24);
				animation.addByPrefix('singRIGHT', 'vita lol right', 24);
				animation.addByPrefix('singDOWN', 'vita lol down', 24);
				animation.addByPrefix('singLEFT', 'vita lol left', 24);
			...
			case 'gf':
				...
				playAnim('danceRight');
			case 'longhorn':
				// LONGHORN/WINDOWS GF CODE
				tex = Paths.getSparrowAtlas('GF_longhorn','shared',true);
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
